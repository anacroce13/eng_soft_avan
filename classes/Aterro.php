<?php
    class Aterro{
        ...
        public function atualizarAterro(){
            $sqlQuery = "UPDATE
                        ". $this->tabela ."
                         SET nome = :nome
                         WHERE id = :id";
